                ...
                <img src="src/assets/logo.png" alt="logo"
                  ...
                  <div>
                    <ul className='flex gap-[60px] font-medium w-full justify-center items-center mt-4 pr-[33rem] text-[16px]'>
                      <Link to="/header"> <li className='cursor-pointer'> Home </li></Link>
                  ...
                  <Link to="/signup1"><button className="border text-[16px] text-[#ffffff]  bg-[#7D66BD] w-[116px] h-[40px] fixed right-[20px] top-[10px] rounded-[7px]"  >
                   Login
                </button></Link>
              </div>
